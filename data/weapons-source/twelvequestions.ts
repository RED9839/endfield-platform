    ...
    },
    {
      ...
      levelValues: [
        ...
        },
        {
          rank: "2",
          description:
            "보조 능력치 +6.0%\n장착자가 아츠 이상 효과를 소모한 후, 공격력 +9.0%, 20초 동안 지속.\n같은 이름의 효과는 최대 2스택까지 중첩되며, 중첩될 때마다 지속 시간은 따로 계산됩니다.",
          stats: [
        ...
        },
        {
          rank: "3",
          description:
            "보조 능력치 +7.0%\n장착자가 아츠 이상 효과를 소모한 후, 공격력 +10.5%, 20초 동안 지속.\n같은 이름의 효과는 최대 2스택까지 중첩되며, 중첩될 때마다 지속 시간은 따로 계산됩니다.",
          stats: [
            { label: "보조 능력치", value: "+7.0%" },
            { label: "공격력", value: "+10.5%" },
          ],
        },
        {
          rank: "4",
          description:
            "보조 능력치 +8.0%\n장착자가 아츠 이상 효과를 소모한 후, 공격력 +12.0%, 20초 동안 지속.\n같은 이름의 효과는 최대 2스택까지 중첩되며, 중첩될 때마다 지속 시간은 따로 계산됩니다.",
          stats: [
        ...
        },
        {
          rank: "5",
          description:
            "보조 능력치 +9.0%\n장착자가 아츠 이상 효과를 소모한 후, 공격력 +13.5%, 20초 동안 지속.\n같은 이름의 효과는 최대 2스택까지 중첩되며, 중첩될 때마다 지속 시간은 따로 계산됩니다.",
          stats: [
            { label: "보조 능력치", value: "+9.0%" },
            { label: "공격력", value: "+13.5%" },
          ],
        },
        {
          rank: "6",
          description:
            "보조 능력치 +10.0%\n장착자가 아츠 이상 효과를 소모한 후, 공격력 +15.0%, 20초 동안 지속.\n같은 이름의 효과는 최대 2스택까지 중첩되며, 중첩될 때마다 지속 시간은 따로 계산됩니다.",
          stats: [
        ...
        },
        {
          rank: "7",
          description:
            "보조 능력치 +11.0%\n장착자가 아츠 이상 효과를 소모한 후, 공격력 +16.5%, 20초 동안 지속.\n같은 이름의 효과는 최대 2스택까지 중첩되며, 중첩될 때마다 지속 시간은 따로 계산됩니다.",
          stats: [
            { label: "보조 능력치", value: "+11.0%" },
            { label: "공격력", value: "+16.5%" },
          ],
        },
        {
          rank: "8",
          description:
            "보조 능력치 +12.0%\n장착자가 아츠 이상 효과를 소모한 후, 공격력 +18.0%, 20초 동안 지속.\n같은 이름의 효과는 최대 2스택까지 중첩되며, 중첩될 때마다 지속 시간은 따로 계산됩니다.",
          stats: [
        ...
        },
        {
          rank: "9",
          description:
            "보조 능력치 +14.0%\n장착자가 아츠 이상 효과를 소모한 후, 공격력 +21.0%, 20초 동안 지속.\n같은 이름의 효과는 최대 2스택까지 중첩되며, 중첩될 때마다 지속 시간은 따로 계산됩니다.",
          stats: [
