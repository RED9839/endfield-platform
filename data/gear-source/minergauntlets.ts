...
export const minergauntlets: GearDetail = {
  slug: "minergauntlets",
  name: "광산 금속 장갑",
  enName: "Miner Gauntlets",
  category: "gloves",
  level: 20,
  quality: 1,
  setName: "세트 없음",
  image: "/gear/minergauntlets.webp",
  ...
  baseStat: { label: "방어력", value: "+12" },
  ability1: { label: "힘", values: { base: "+20" } },
  ability2: { label: "민첩", values: { base: "+13" } },
  attribute: { label: "생명력", values: { base: "+11.0%" } },
