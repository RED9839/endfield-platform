...
export const minerturbine: GearDetail = {
  slug: "minerturbine",
  name: "광산 과급기",
  enName: "Miner Turbine",
  category: "kit",
  level: 36,
  quality: 3,
  setName: "세트 없음",
  image: "/gear/minerturbine.webp",
  ...
  ability1: { label: "힘", values: { base: "+22" } },
  attribute: { label: "연계 스킬 피해 보너스", values: { base: "+22.8%" } },
