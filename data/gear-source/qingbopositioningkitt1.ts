...
export const qingbopositioningkitt1: GearDetail = {
  slug: "qingbopositioningkitt1",
  name: "청파 위치 지정기 · I",
  enName: "Qingbo Positioning Kit T1",
  category: "kit",
  level: 70,
  quality: 5,
  setName: "청파",
  image: "/gear/qingbopositioningkitt1.webp",
  summary:
  ...
  setEffects: [
    {
      pieces: 3,
      description:
        "장착자의 연계 스킬 쿨타임 감소 +85%. 장착자가 연계 스킬을 사용할 때, 모든 스킬 피해 +20%, 15초 동안 지속. 해당 효과는 최대 2스택까지 중첩되며 중첩될 때마다 지속 시간은 따로 계산됩니다.",
    },
  ],
};
