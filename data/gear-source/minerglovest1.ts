...
export const minerglovest1: GearDetail = {
  slug: "minerglovest1",
  name: "광산 장갑 · I",
  enName: "Miner Gloves T1",
  category: "gloves",
  level: 36,
  quality: 3,
  setName: "세트 없음",
  image: "/gear/minerglovest1.webp",
  ...
  ability1: { label: "지능", values: { base: "+36" } },
  ability2: { label: "민첩", values: { base: "+24" } },
  attribute: { label: "생명력", values: { base: "+19.0%" } },
