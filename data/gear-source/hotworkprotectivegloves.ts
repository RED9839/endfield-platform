...
export const hotworkprotectivegloves: GearDetail = {
  "slug": "hotworkprotectivegloves",
  "name": "열 작업용 보호 장갑",
  "enName": "Hot Work Protective Gloves",
  "category": "gloves",
  "level": 70,
  "quality": 5,
  "setName": "열 작업용",
  "image": "/gear/hotworkprotectivegloves.webp",
  "summary": "이 장비는 엔드필드 공업에서 자체 연구하고, 통합 공업 시스템을 사용해 제작한 것으로, 사용자의 작전 능력을 올릴 수 있습니다.",
  "description": "극도의 내열성을 자랑하는 장비.\n방호 성능과 기동성을 모두 고려한 장갑으로, 사용자가 고온에 다치지 않고 목표물에 접촉할 수 있게 해 줍니다.",
  "baseStat": {
    "label": "방어력",
    "value": "+42"
  },
