...
export const minerglovest2: GearDetail = {
  slug: "minerglovest2",
  name: "광산 장갑 · II",
  enName: "Miner Gloves T2",
  category: "gloves",
  level: 50,
  quality: 4,
  setName: "세트 없음",
  image: "/gear/minerglovest2.webp",
  ...
  ability1: { label: "지능", values: { base: "+49" } },
  ability2: { label: "민첩", values: { base: "+32" } },
  attribute: { label: "공격력", values: { base: "+13.0%" } },
