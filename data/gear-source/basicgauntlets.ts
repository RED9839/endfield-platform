...
export const basicgauntlets: GearDetail = {
  slug: "basicgauntlets",
  name: "간편 금속 장갑",
  enName: "Basic Gauntlets",
  category: "gloves",
  level: 10,
  quality: 1,
  setName: "세트 없음",
  image: "/gear/basicgauntlets.webp",
  ...
  ability1: { label: "힘", values: { base: "+11" } },
  ability2: { label: "민첩", values: { base: "+7" } },
