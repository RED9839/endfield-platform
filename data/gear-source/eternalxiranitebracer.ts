...
export const eternalxiranitebracer: GearDetail = {
  "slug": "eternalxiranitebracer",
  "name": "식양의 숨결 보호대",
  "enName": "Eternal Xiranite Bracer",
  "category": "gloves",
  "level": 70,
  "quality": 5,
  "setName": "식양의 숨결",
  "image": "/gear/eternalxiranitebracer.webp",
  "summary": "이 장비는 홍산 선검국에서 설계하고, 통합 공업 시스템을 사용해 제작한 것으로, 사용자의 작전 능력을 올릴 수 있습니다.",
  "description": "어느 '광기에 찬' 천사가 남긴 유작.\n\"식양을 섬유에 엮어 넣겠다고? 너 미쳤어?\"",
  "baseStat": {
    "label": "방어력",
    "value": "+42"
  },
