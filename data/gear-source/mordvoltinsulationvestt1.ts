...
export const mordvoltinsulationvestt1: GearDetail = {
  slug: "mordvoltinsulationvestt1",

  name: "침식 차단 조끼 · I",
  enName: "Mordvolt Insulation Vest T1",
  ...
  image: "/gear/mordvoltinsulationvestt1.webp",
  summary:
