...
export const minercommt1: GearDetail = {
  slug: "minercommt1",
  name: "광산 통신기 · I",
  enName: "Miner Comm T1",
  category: "kit",
  level: 50,
  quality: 4,
  setName: "세트 없음",
  image: "/gear/minercommt1.webp",
  ...
  ability1: { label: "의지", values: { base: "+31" } },
  attribute: { label: "치유 효율 보너스", values: { base: "+15.6%" } },
  abilityTypes: ["will"],
