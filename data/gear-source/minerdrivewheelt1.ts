...
export const minerdrivewheelt1: GearDetail = {
  slug: "minerdrivewheelt1",
  name: "광산 전동기 · I",
  enName: "Miner Drive Wheel T1",
  category: "kit",
  level: 50,
  quality: 4,
  setName: "세트 없음",
  image: "/gear/minerdrivewheelt1.webp",
  ...
  ability1: { label: "민첩", values: { base: "+31" } },
  attribute: { label: "연계 스킬 피해 보너스", values: { base: "+31.2%" } },
