...
export const aicfieldworkwraps: GearDetail = {
  "slug": "aicfieldworkwraps",
  "name": "통합 실전 훈련 붕대",
  "enName": "AIC Fieldwork Wraps",
  "category": "gloves",
  "level": 60,
  "quality": 5,
  "setName": "통합 실전 훈련",
  "image": "/gear/aicfieldworkwraps.webp",
  "summary": "이 장비는 엔드필드 공업에서 자체 연구하고, 통합 공업 시스템을 사용해 제작한 것으로, 사용자의 작전 능력을 올릴 수 있습니다.",
  "description": "엔드필드가 오퍼레이터 훈련을 위해 설계한 작전 장비 세트입니다. 품질에 비해 가격이 지나치게 저렴해 시장에서도 큰 인기를 얻고 있습니다.\n전장에서도 복잡한 장비를 조작해야 하는 오퍼레이터를 위해 설계된 특수 손 보호 장비입니다.",
  "baseStat": {
    "label": "방어력",
    "value": "+36"
  },
