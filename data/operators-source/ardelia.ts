...
const ARDELIA_TALENT_COSTS = [
  {
    ...
    elite: 1,
    materials: [
      { name: "프로토콜 프리즘", count: 36, icon: "/items/프로토콜 프리즘.webp" },
      { name: "탈로시안 화폐", count: 7200, icon: "/items/탈로시안 화폐.webp" },
    ],
  },
  {
    talent: 1,
    ...
    elite: 2,
    materials: [
      { name: "프로토콜 프리즘", count: 86, icon: "/items/프로토콜 프리즘.webp" },
      { name: "탈로시안 화폐", count: 26000, icon: "/items/탈로시안 화폐.webp" },
    ],
  },
  {
    talent: 2,
    ...
    elite: 2,
    materials: [
      { name: "프로토콜 프리즘", count: 85, icon: "/items/프로토콜 프리즘.webp" },
      { name: "탈로시안 화폐", count: 26000, icon: "/items/탈로시안 화폐.webp" },
    ],
  },
] as const;
