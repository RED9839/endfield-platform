...
export const akekuriOperatorDetailData = {
  slug,
  name: "아케쿠리",
  enName: "Akekuri",
  rarity: 4 as const,
  ...
  talents: [
    {
      ...
      description: "지능 10포인트마다 연계 스킬 섬광 돌진으로 회복하는 스킬 게이지 +1.0%, 최대 회복 50%",
    },
    {
      name: "승리의 함성",
      unlock: "Promote to E2 to activate the upgraded effect",
      icon: `/operators/${slug}/talents/talent1.webp`,
      description: "지능 10포인트마다 연계 스킬 섬광 돌진으로 회복하는 스킬 게이지 +1.5%, 최대 회복 75%",
    },
    {
      name: "몰입의 시간",
  ...
  potential: [
    ...
    },
    {
      title: "3",
      subtitle: "혼신의 협력",
      description: "궁극기 소대, 집합!이 지속되는 동안, 팀 전체 공격력 +10%",
    },
    {
      title: "4",
      subtitle: "완벽한 컨디션",
      description: "궁극기 소대, 집합!의 사용에 필요한 궁극기 에너지 -10%",
    },
    {
      title: "5",
      subtitle: "검의 리듬",
      description: "재능 '몰입의 시간' 효과 강화: 연타가 궁극기 소대, 집합!이 끝난 뒤에도 5초 동안 지속됩니다.",
    },
  ],
