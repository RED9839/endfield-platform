  ...
  return (
    <div className="mb-4 flex flex-wrap items-center gap-2">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <div className="hud-tile flex items-center gap-1.5 px-2.5 py-1.5" style={CUT} title="전술 칩 — 스킬 강화 전용 재료">
          <img src={RESOURCE_ICON.chips} alt="" className="h-4 w-4 shrink-0 object-contain" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} /><span className="font-mono text-sm font-bold text-white">{craft.mats.chips ?? 0}</span><span className="font-mono text-[14px] text-ef-muted">전술칩</span>
        </div>
