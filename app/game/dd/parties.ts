...
export const PRESET_PARTIES: PresetParty[] = [
  {
    id: "laevatain",
    name: "레바테인 조합",
    members: ["laevatain", "wulfgard", "ardelia", "camu"],
    element: "heat",
    archetype: "arts",
    desc: "레바테인 열기 폭딜 — 울가 연소 서브딜 · 아델리아/질베 서포터 · 카뮤 뱅가드",
    note: "4돌 기준",
    alternates: [
      { role: "3번 서포터", ids: ["ardelia", "gilberta"], note: "아델리아 / 질베르타(몹몰이)" },
  ...
  },
  {
    id: "yvonne",
    name: "이본 조합",
    members: ["yvonne", "tangtang", "xaihi", "gilberta"],
    element: "cryo",
    archetype: "arts",
    desc: "이본 냉기 치명 — 탕탕 서브딜 · 자이히 냉기 증폭 · 질베/펠/에스텔라 유동",
    note: "1돌",
    alternates: [{ role: "4번 유동", ids: ["gilberta", "perlica", "estella"], note: "질베르타 / 펠리카 / 에스텔라" }],
  },
  {
    id: "lastrite",
    name: "라스트 라이트 조합",
    members: ["lastrite", "xaihi", "tangtang", "gilberta"],
    element: "cryo",
    archetype: "arts",
    desc: "라스트 라이트 냉기 누킹 — 자이히 냉기 증폭 · 탕탕 서브딜 · 질베/펠/아케 유동",
    note: "1,3,4,5돌 (혹은 탕탕 채용)",
    alternates: [{ role: "4번 유동", ids: ["gilberta", "perlica", "akekuri"], note: "질베르타 / 펠리카 / 아케쿠리" }],
  },
  {
    id: "zhuangfangyi",
    name: "장방이 조합",
    members: ["zhuangfangyi", "perlica", "arclight", "alesh"],
    element: "electric",
    archetype: "arts",
    desc: "장방이 전기 딜 — 펠리카 감전 셋업 · 아크라이트/아케 게이지 · 알레쉬 등 유동",
    note: "1,4돌",
    alternates: [
      { role: "3번 뱅가드", ids: ["arclight", "akekuri"], note: "아크라이트 / 아케쿠리" },
      { role: "4번 유동", ids: ["alesh", "antal", "avywenna", "ardelia"], note: "알레쉬 / 안탈 / 아비웨나 / 아델리아" },
    ],
  },
  {
    id: "avywenna",
  ...
  },
  {
    id: "rossi",
    name: "로시 조합",
    members: ["rossi", "wulfgard", "gilberta", "pogranichnik"],
    element: "heat",
    archetype: "crit",
    desc: "로시 치명 딜 — 울가/펠/아케 서브딜 · 질베 취약 · 포그 등 방불 유동",
    note: "1돌",
    alternates: [
      { role: "2번 서브딜", ids: ["wulfgard", "perlica", "akekuri"], note: "울가 / 펠리카 / 아케쿠리" },
      { role: "4번 유동", ids: ["pogranichnik", "tangtang", "mifu", "dapan", "endministrator"], note: "포그 / 탕탕 / 미브 / 판 / 관리자" },
    ],
  },
  {
    id: "mifu",
