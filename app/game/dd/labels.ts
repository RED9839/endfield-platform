...
export const DMG_LABEL: Record<string, string> = {
  ...
  energy: "궁 에너지", ultEff: "궁충 효율", artsStr: "아츠 강도", vsBroken: "불균형 피해", vsDefBreak: "방어 불능 피해", mainPct: "주요 능력치", subPct: "보조 능력치", heal: "치유 효율", dmgReduce: "받는 피해 감소", strPct: "힘", agiPct: "민첩", intPct: "지능", wilPct: "의지",
};
...
export const DMG_SHORT: Record<string, string> = {
  ...
  energy: "궁에너지", ultEff: "궁충효율", artsStr: "아츠강도", vsBroken: "불균형피해", vsDefBreak: "방불피해", mainPct: "주요능력치", subPct: "보조능력치", heal: "치유효율", dmgReduce: "피해감소", strPct: "힘", agiPct: "민첩", intPct: "지능", wilPct: "의지",
};
